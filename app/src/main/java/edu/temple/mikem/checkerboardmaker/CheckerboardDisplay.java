...
public class CheckerboardDisplay extends Fragment {
    ...
    public static CheckerboardDisplay newInstance(String param1, String param2) {
        CheckerboardDisplay fragment = new CheckerboardDisplay();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments() != null && getArguments().get(dataKey) != null) {
            cols = getArguments().getInt(dataKey);
        }
        else{
            cols = 0;
        }
